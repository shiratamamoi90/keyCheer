...
import { onKeyPress, initialRuntimeState, type RuntimeState } from "../../src/engine/runtime.js";
import { ALL_BUCKET_KEYS, bucketKey, type MessagePool } from "../../src/engine/messagePool.js";
import type { BaselineKey } from "../../src/engine/baseline/messages.js";
import { DEFAULT_TRIGGER_CONFIG } from "../../src/shared/types.js";

// spec: specs/key-counter.md / speed-zone.md / cheer-trigger.md を合成した per-keypress の決定的処理。
...
describe("runtime / 通常応援の発動", () => {
  it("fires regular at a multiple of triggers.regular with zone + timeOfDay", () => {
    const now = 1_000_000;
...
describe("runtime / マイルストーン発動と数値補間", () => {
  it("fires milestone and interpolates {milestone} with the reached count", () => {
    const now = 1_000_000;
