...
//
// なぜ types.ts と分けるか: 発動経路(main/index.ts・cheerRuntime.ts・engine/runtime.ts)は
// src/shared/types.ts を import する。プロバイダーの開示情報をそこへ混ぜると、
...
// (changes/0003 の tasks.md 参照)。リンク切れは同意の前提を壊すので必ず人間が確認する。
